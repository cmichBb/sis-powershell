<#
.SYNOPSIS
  Submits a Snapshot Flat File to Blackboard Learn for Processing
.DESCRIPTION
  Submits a feed file to a Snapshot Flat File Student Information System Integraion on Blackboard Learn for processing, and returns a Data Set UID that can be used to monitor the status of the submitted feed file
.EXAMPLE
  Send-SnapshotFlatFile -Server "blackboard.monument.edu" -RecordType CourseMembership -OperationType Store -IntegrationUsername "01928374-5647-4abc-faeb-0156924783af" -IntegrationPassword "thisisnotagoodpassword" -FeedFile D:\path_to_feed_file.txt
.EXAMPLE
...
#>
function Send-SnapshotFlatFile
{
